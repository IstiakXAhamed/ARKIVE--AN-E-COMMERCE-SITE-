...
const AI_FEATURES: AIFeature[] = [
  ...
  // Product Features
  { id: 'image_studio', name: 'AI Image Studio (Coming Soon)', description: 'Smart image search with Gemini keywords', icon: Image, enabled: false, category: 'product' },
