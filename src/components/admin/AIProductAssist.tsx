...
export default function AIProductAssist({
  productName,
  category,
  currentDescription,
  onSuggestionAccept,
  onAnalysisResult,
}: AIProductAssistProps) {
  ...
  const autoFillAll = async () => {
    ...
    if (data) {
      ...
      if (data.description)
        onSuggestionAccept("description", data.description);
      if (data.category) onSuggestionAccept("category", data.category);
      if (data.suggestedPrice)
        onSuggestionAccept("basePrice", data.suggestedPrice);
      ...
      if (data.isFeatured !== undefined)
        onSuggestionAccept("isFeatured", data.isFeatured);
        ...
        {analysis && (
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              {analysis.suggestedVariants?.sizes &&
      ...
      <AnimatePresence>
        {showSuggestion &&
          ...
          showSuggestion !== "complete" && (
            ...
            >
              <p className="text-sm font-semibold text-purple-600 mb-2 capitalize">
              ...
              <div className="flex gap-2 mt-3">
                <Button
                  ...
                  size="sm"
                  onClick={() =>
                    acceptSuggestion(showSuggestion as string)
                  }
                  className="gap-2"
                >
