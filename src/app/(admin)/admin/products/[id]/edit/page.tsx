...
import {
  ArrowLeft, Save, Loader2, AlertCircle, Sparkles,
  Package, Tag, Image as ImageIcon, Search,
  Eye, EyeOff, Star
} from "lucide-react";
...
export default function EditProductPage() {
      ...
      try {
        ...
        if (productId) {
          ...
          setForm({
            ...
            salePrice: product.originalPrice?.toString() || "", // mapped from originalPrice
            ...
            variantPricing: product.variantPricing ?? false,
          });
  ...
  const handleChange = (
    ...
    setForm((prev) => ({
      ...prev,
      [name]: value,
      // Auto-update slug/metaTitle only if it's a new product or user explicitly wants sync. 
      // For Edit, usually better NOT to auto-change slug to avoid breaking links.
      // So we remove the auto-slug logic here for Edit mode.
    }));
  };
  ...
  if (error && !form.name) {
    return (
      <div className="flex h-screen flex-col items-center justify-center bg-gray-50 text-center p-4">
        ...
        <h2 className="text-xl font-bold text-gray-900">Error Loading Product</h2>
      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 leading-tight">Edit Product</h1>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-t border-gray-200 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between lg:pl-72">
            <div className="flex items-center gap-2 text-xs text-gray-500">
              ...
              {form.isActive ? "Will be published visible to customers" : "Will be hidden (Draft)"}
            </div>
            <div className="flex items-center gap-3">
              <Link
                href="/admin/products"
